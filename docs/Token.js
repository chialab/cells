...
export class DesignToken extends Component {
    ...
    render() {
        switch (this.type) {
            ...
            default:
                return html`<div
                    class=${`design-token__wrapper px-2 py-1 radius-1 elevation-1 ${!this.name ? this.rule : ''}`}>
                    ${this.renderTokens()}
                    <slot />
                </div>`;
        }
    ...
    renderTokens() {
        return html`<div class="design-token__name">
            ${this.name && this.renderToken(this.name)} ${this.rule && this.renderToken(this.rule)}
    ...
    renderSpacing() {
        return html`<div class="design-token__wrapper px-2 py-1 radius-1 elevation-2">
            <div
                class="design-token__spacing"
                style=${{ height: `var(${this.name})` }}></div>
            ${this.renderTokens()}
            <slot />
        </div>`;
    }
    ...
    renderMargin() {
        return html`<div class="design-token__wrapper bg-neutral radius-1 elevation-2">
            <div
                class=${`bg-surface p-2 radius-1 flex ${!this.name ? this.rule : ''}`}
                style=${{ margin: `var(${this.name})` }}>
                ${this.renderTokens()}
            </div>
            <slot />
        </div>`;
    ...
    renderPadding() {
        return html`<div
            class=${`design-token__wrapper bg-neutral radius-1 elevation-2 ${!this.name ? this.rule : ''}`}
            style=${{ padding: `var(${this.name})` }}>
            <div class="bg-surface radius-1 flex column center align-center"> ${this.renderTokens()} </div>
            <slot />
        </div>`;
    }
    ...
    renderText() {
        return html`<div class="design-token__wrapper px-2 py-1 radius-1 elevation-2">
            ...
            <p class=${`design-token__paragrapgh ${!this.name ? this.rule : ''}`}>
                ${this.slotChildNodes.length
                    ? html`<slot />`
                    : 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nobis blanditiis, obcaecati ex earum sunt mollitia voluptatem dignissimos! Culpa vitae, quas cum asperiores aspernatur dolor deserunt unde hic nostrum quod molestiae.'}
            </p>
        </div>`;
    }
    ...
    renderFamily() {
        return html`<div class="design-token__wrapper">
            <p
                class=${`design-token__paragrapgh f-3 ${!this.name ? this.rule : ''}`}
                style=${{ fontFamily: `var(${this.name})` }}>
                ${this.slotChildNodes.length
                    ? html`<slot />`
    ...
    renderSize() {
        return html`<div class="design-token__wrapper">
            <p
                class=${`design-token__paragrapgh ${!this.name ? this.rule : ''}`}
                style=${{ fontSize: `var(${this.name})` }}>
                ${this.slotChildNodes.length
                    ? html`<slot />`
                    : 'Lorem ipsum dolor, sit amet consectetur adipisicing elit.'}
            </p>
    ...
    renderWeight() {
        return html`<div class="design-token__wrapper">
            <p
                class=${`design-token__paragrapgh f-3 ${!this.name ? this.rule : ''}`}
                style=${{ fontWeight: `var(${this.name})` }}>
                ${this.slotChildNodes.length
                    ? html`<slot />`
                    : 'Lorem ipsum dolor, sit amet consectetur adipisicing elit.'}
            </p>
    ...
    renderColor() {
        return html`<div
            class="design-token__wrapper"
            style=${{ color: `var(${this.name})` }}>
            ${this.renderTokens()}
        </div>`;
    }
    ...
    renderBackground() {
        return html`<div
            class="design-token__wrapper px-2 py-1 radius-1 elevation-2"
            style=${{ background: `var(${this.name})` }}>
            ${this.renderTokens()}
            <slot />
        </div>`;
    }
    ...
    renderShadow() {
        return html`<div
            class="design-token__wrapper px-2 py-1 radius-1"
            style=${{ boxShadow: `var(${this.name})`, border: 'solid 1px #e5e5e5' }}>
            ${this.renderTokens()}
            <slot />
        </div>`;
    }
    ...
    renderRadius() {
        return html`<div
            class=${`design-token__wrapper center align-center p-2 elevation-2 ${!this.name ? this.rule : ''}`}
            style=${{ borderRadius: `var(${this.name})` }}>
            ${this.renderTokens()}
            <slot />
        </div>`;
    }
